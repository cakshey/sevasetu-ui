// uploadServiceProviders_byCategory.js
...
async function uploadProviders() {
  console.log(`🚀 Uploading ${providers.length} service providers (by category)...`);
  ...
  providers.forEach((provider) => {
    ...
    // Each category becomes a subcollection inside 'service_providers'
    const ref = db
      .collection("service_providers")
      .doc(category) // category doc
      .collection("providers") // subcollection
  ...
  await batch.commit();
  console.log("✅ Upload complete! Data organized by category 🎯");
}
